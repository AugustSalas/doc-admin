...
@Component({
  selector: 'app-documentos-activos',
  templateUrl: './documentos-activos.component.html',
  styleUrls: ['./documentos-activos.component.scss']
})
export class DocumentosActivosComponent implements OnInit {
