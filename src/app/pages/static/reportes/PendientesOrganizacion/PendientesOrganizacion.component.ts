...
@Component({
  selector: "app-PO",
  templateUrl: "./PendientesOrganizacion.component.html",
  styleUrls: ["./PendientesOrganizacion.component.scss"],
})
export class RPendientesOComponent implements OnInit {
...
debugger
    peticion = this.dinamicoService.imprimirReporte("/webresources/documentofisico/reporte/PendientesOrganizacion" , postObject);
