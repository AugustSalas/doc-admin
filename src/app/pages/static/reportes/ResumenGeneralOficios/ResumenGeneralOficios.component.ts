...
@Component({
  selector: 'app-RGO',
  templateUrl: './ResumenGeneralOficios.component.html',
  styleUrls: ['./ResumenGeneralOficios.component.scss']
})

export class RGDOComponent implements OnInit {
...
debugger
    peticion = this.dinamicoService.imprimirReporte("/webresources/documentofisico/reporte/GeneralOficios" , postObject);
