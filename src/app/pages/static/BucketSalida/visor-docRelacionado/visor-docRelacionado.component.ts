...
@Component({
  selector: 'app-macro',
  templateUrl: './visor-docRelacionado.component.html',
  styleUrls: ['./visor-docRelacionado.component.scss']
})

export class VisorDocRelacionadoComponent implements OnInit {
