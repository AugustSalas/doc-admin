...
@Component({
  selector: 'app-macro',
  templateUrl: './turnosEnviados-visor.component.html',
  styleUrls: ['./turnosEnviados-visor.component.scss']
})

export class TurnosEnviadosVisorComponent implements OnInit {
